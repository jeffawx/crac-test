...
docker run -d --privileged --rm --name=crac-test --ulimit nofile=1024 -p 8080:8080 -v $(pwd)/build/libs:/opt/mnt -e FLAG=$1 -e APP_SECRET=test jeffawx/crac-test:builder
